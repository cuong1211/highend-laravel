...
@section('breadcrumb')
    <div class="page-title d-flex flex-column me-5">
        <!--begin::Title-->
        <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Quản lý sản phẩm</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-dark">sản phẩm</li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
                        ...
                        <div class="col-8">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <!--begin::Card title-->
                                    <div class="card-title fs-3 fw-bolder">Chỉnh sửa sản phẩm</div>
                                    <!--end::Card title-->
                                </div>
                                <!--end::Card header-->
                                <!--begin::Form-->
                                ...
                                <div class="card-body p-9">
                                    ...
                                    <div class="row mb-5">
                                        <!--begin::Col-->
                                        <div class="col-xl-3">
                                            <div class="fs-6 fw-bold mt-2 mb-3">Thumbnail</div>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-lg-8">
                                    ...
                                    <div class="row mb-5">
                                        <!--begin::Dropzone-->
                                        <div class="col-xl-3">
                                            <div class="fs-6 fw-bold mt-2 mb-3">Hình ảnh</div>
                                        </div>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="row mb-8">
                                        <!--begin::Col-->
                                        <div class="col-xl-3">
                                            <div class="fs-6 fw-bold mt-2 mb-3">Tên sản phẩm</div>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                    ...
                                    <div class="row mb-8">
                                        <!--begin::Col-->
                                        <div class="col-xl-3">
                                            <div class="fs-6 fw-bold mt-2 mb-3">Mô tả</div>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-xl-9 fv-row">
...
@push('jscustom')
    <script>
        ...
        let myDropzone = new Dropzone("#image", {
            ...
            parallelUploads: 10,
            init: function() {
                this.querySelector("button[type=submit]").addEventListener("click", function(e) {
                ...
                this.on("addedfile", function(file) {
                    ...
                    var removeButton = Dropzone.createElement(
                        "<button class='btn btn-sm btn-light-danger btn-hover-danger btn-sm btn-icon btn-icon-sm'><i class='flaticon2-trash'></i></button>"
                    );
        ...
        $('#kt_project_settings_form').submit(function(e) {
            e.preventDefault();
            let formData = new FormData(this);
            $.ajax({
                url: "{{ route('product.update', ['type' => $id, '']) }}" + '/' + "{{ $type }}",
                headers: {
